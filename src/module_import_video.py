...
result = describe_video_0shot(client, system_prompt, text_prompt=user_prompt, base64_frames=extracted_frames, max_tokens=500, detail_level="low", respons_type="text", s=7, temp=0.5)
